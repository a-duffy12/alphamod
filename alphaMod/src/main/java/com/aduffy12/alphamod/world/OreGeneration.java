...
public class OreGeneration {
	...
	public static void setupOreGeneration() {
		...
		CountRangeConfig amber_ore_placement_jungle_edge = new CountRangeConfig(OreGenConfig.amber_jungle_hills_chance.get(), OreGenConfig.amber_max_height.get(), 0, OreGenConfig.amber_max_height.get());
